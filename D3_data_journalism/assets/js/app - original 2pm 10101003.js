...
function makeResponsive() {
  ...
  // function updateToolTip(chosenXAxis, chosenYAxis, circlesGroup) { // comment out update tooltip and where it is called
  ...
  //     label = "in Poverty (%):"; // QUESTION:  WHY is this needed???
  ...
  //   // NOT TESTED YET
  //   circlesGroup.call(toolTip); // changed from circlesGroup.call(toolTip);
  ...
  d3.csv("assets/data/data.csv").then(function (chartData, err) {
    ...
    // DEBUG!! -- y axis and plot not right when replotting
    // QUESTION:  WHAT IS chartGroup?
    // append y axis
    var yAxis = chartGroup.append("g") // added var yAxis =.  caused 
